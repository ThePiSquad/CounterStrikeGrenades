...
// SMOKE GRENADES
const val SMOKE_GRENADE_RADIUS = 5
const val SMOKE_GRENADE_PARTICLE_COUNT = 800
const val SMOKE_GRENADE_SPREAD_TIME = 0.5
const val SMOKE_GRENADE_TOTAL_GENERATION_TIME = 2